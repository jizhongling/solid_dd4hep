...
python material_recording_epic.py -i ${DETECTOR_PATH}/${DETECTOR_CONFIG}.xml -n ${nevents} -t ${nparticles} -o ${recordingFile} --eta_min 1.0 --eta_max 3.5
echo "::endgroup::"
...
# output: material-map.json or cbor. This is the material map that you want to provide to EICrecon, i.e.  -Pacts:MaterialMap=XXX  .Please --matFile to specify the name and type
#         material-map_tracks.root(recorded steps from geantino, for validation purpose)
...
# TODO: End here, delete to continue
exit 0
